        ...
        <div className="app__auth min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-6xl relative z-10">
                ...
                <div className="text-center mb-12 animate-fade-in">
                    <h1 className="text-4xl font-bold text-gray-800 mb-4 animate-slide-down">my DMO-Card</h1>
                </div>
                    ...
                    <div
                        ...
                        <div className="p-8">
                            <div className="flex items-center mb-6">
                                ...
                                <h2 className="text-2xl font-semibold text-gray-800 ml-4">Individual Access</h2>
                            </div>

                            {/* Image placeholder */}
                            <div className="flex flex-row items-center gap-1">
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                    Personal Access allows you to activate your card and manage your medical record associated with your
                                    DMO-Card.
                                </p>
                    ...
                    <div
                        ...
                        <div className="p-8">
                            <div className="flex items-center mb-6">
                                ...
                                <h2 className="text-2xl font-semibold text-gray-800 ml-4">Health Professional Access</h2>
                            </div>

                            {/* Image placeholder */}
                            <div className="flex flex-row items-center gap-1">
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                    Access for a health care professional allows you to access the entire medical record of the patient,
                                    subject to his or her authorization.
                                </p>
                                <div className="rounded-lg h-40 mb-6 flex items-center justify-center">
                                    <div className="text-center">
                            ...
                            <button className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center group">
                                <span>Accessing a patient's DMO-Card</span>
                                <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform duration-200" size={20} />
                            </button>
                        </div>
                    </div>
                ...
                <div className="emergency-container">
                    <div className="emergency-header">
                        <div className="header-content">
                            ...
                            <h2 className="emergency-title">Emergency Overview</h2>
                        </div>
                    </div>
                    ...
                    <div className="emergency-body">
                        ...
                        <p className="emergency-description">Quick access to critical medical information during emergencies</p>
                    </div>
                </div>
            </div>
        </div>
