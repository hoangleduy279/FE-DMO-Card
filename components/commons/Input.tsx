        ...
        return (
            <form
                ...
                <input
                    ...
                    name={name}
                    disabled={disabled}
                    className={`w-full px-4 py-3.5 bg-gray-50/80 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-200 placeholder-gray-400 text-gray-800 font-medium hover:bg-gray-100/50 ${className}`}
